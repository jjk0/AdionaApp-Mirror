    ...
    <ScrollView style={styles.sectionContainer}>
      ...
      <Box bgColor="#517FF3" m="0">
        ...
        <Pressable
          ...
          width="1/3"
          alignSelf="flex-end"
          onPress={() => navigation.navigate('Overall Trends')}>
          <HStack alignSelf="center" m="2">
            <Text m="0.5" color="black" fontSize="16">
              See trends
            </Text>
            <Icon
              name="arrow-right"
      ...
      <VStack px="4">
        <Pressable
          ...
          <Box bgColor="#F0402A" my="4" borderRadius="2xl">
            ...
            <View
              style={{position: 'absolute', top: -100, right: -40}}
              size={400}>
              <Vector9 />
            </View>
              ...
              <VStack>
                <HStack>
                  <Icon
                    ...
                    alignSelf="start"
                  />
                  <Text fontSize={25} alignSelf="center" ml="3" color="white">
                    Alert
                  </Text>
                </HStack>

                <Text fontSize={20} color="white">
                  John might get agitated soon. Tap to see our recommendations
                </Text>
              </VStack>
            </Box>
          </Box>
        ...
        <Pressable
          ...
          mb="10"
          p="25"
          onPress={() => setShowAgitationModal(true)}>
          <HStack>
            <Icon
              ...
              alignSelf="start"
            />
            <Text fontSize={25} alignSelf="center" ml="3" color="black">
              Info
            </Text>
          </HStack>
        ...
        <VStack marginY="5" alignSelf="flex-start">
          <HomeIconButton
            navigateToPage="Overall Trends"
            buttonColor="info.500"
            iconTitle="trending-up"
            mainText="Tips and Trends"
            tipText="John could get more sleep"
          />
          <HomeIconButton
            navigateToPage="Main Location"
            buttonColor="info.200"
            iconTitle="map-marker-radius-outline"
            mainText="Location"
            tipText="1234 Main Street"
          />
          <HomeIconButton
            navigateToPage="Diary Main Screen"
            buttonColor="warning.200"
            iconTitle="notebook-outline"
            mainText="Daily Diary"
            tipText="Log important info here"
          />
        </VStack>
