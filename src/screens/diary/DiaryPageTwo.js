...
const DiaryPageTwo = ({navigation}) => {

    const [groupValues, setGroupValues] = useState([]);


    const checkboxOptions = ['appears anxious or worried', 'threatens physical harm', 'appears sad or depressed', 'expressed feelings of hopelessness or sadness', 'crying or fearfulness', 'feeling lonely','talking about being a burden', 'repeating the same question','trouble remembering recent events','losing or misplacing things', 'forgetting time of day', 'starting but not finishing something', 'difficulty concentrating',]
        ...
        <KeyboardAvoidingView style = {{ flex: 1 }} behavior="padding" enabled   keyboardVerticalOffset={100}>
            <ScrollView pb='5'>
                ...
                <VStack mt='10'>
                    ...
                    <Pressable onPress={() => navigation.navigate('Diary Page Three')}>
